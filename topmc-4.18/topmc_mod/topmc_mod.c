...
ssize_t  topmc_cr4_pce_read(struct file *filp, char __user  *buffer,size_t count,loff_t *offp ) 
{
    int cpu;
    int pce;
    int is_set=1;
...
ssize_t topmc_cr4_pce_write(struct file *filp, const  char __user *buffer,size_t count,loff_t *offp ) 
{
    int i;
    int cpu;
    unsigned int sum = 0;
...
ssize_t topmc_enable_all_read(struct file *filp,char *buffer,size_t count,loff_t *offp ) 
{
...
ssize_t topmc_enable_all_write(struct file *filp, const char *buffer,size_t count,loff_t *offp ) 
{
...
ssize_t topmc_enable_read(struct file *filp,char __user *buffer,size_t count,loff_t *offp ) 
{
...
ssize_t topmc_enable_write(struct file *filp, const char *buffer,size_t count,loff_t *offp ) 
{
...
ssize_t topmc_event_read(struct file *filp,char *buffer,size_t count,loff_t *offp )
{
...
ssize_t topmc_event_write(struct file *filp, const char *buffer,size_t count,loff_t *offp ) 
{
...
ssize_t topmc_value_read(struct file *filp,char *buffer,size_t count,loff_t *offp ) 
{
...
ssize_t topmc_value_write(struct file *filp, const char *buffer,size_t count,loff_t *offp ) 
{
